...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    -- Metadata
    PlayerData.metadata = PlayerData.metadata or {} PlayerData.metadata["communityservice"] = PlayerData.metadata["communityservice"] or 0 -- qb-community-service
...
function QBCore.Player.CreatePlayer(PlayerData, Offline)
    ...
    function self.Functions.GetMoney(moneytype)
        ...
        moneytype = moneytype:lower()
        print(464, moneytype)
        print(465, self.PlayerData.money[moneytype])
...
function QBCore.Player.SaveOffline(PlayerData)
    if PlayerData then
        ...
        if GetResourceState('codem-inventory') ~= 'missing' then
            exports['codem-inventory']:SaveInventory(PlayerData,
                true)
        end
