...
local Vehicles = {
    ...
    --- Motorcycles (8)
    { model = 'akuma',         name = 'Akuma',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'avarus',        name = 'Avarus',                        brand = 'LCC',             price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'bagger',        name = 'Bagger',                        brand = 'WMC',             price = 13500,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'bati',          name = 'Bati 801',                      brand = 'Pegassi',         price = 24000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'bati2',         name = 'Bati 801RR',                    brand = 'Pegassi',         price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'bf400',         name = 'BF400',                         brand = 'Nagasaki',        price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'carbonrs',      name = 'Carbon RS',                     brand = 'Nagasaki',        price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'chimera',       name = 'Chimera',                       brand = 'Nagasaki',        price = 21000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'cliffhanger',   name = 'Cliffhanger',                   brand = 'Western',         price = 28500,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'daemon',        name = 'Daemon',                        brand = 'WMC',             price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'daemon2',       name = 'Daemon Custom',                 brand = 'Western',         price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'defiler',       name = 'Defiler',                       brand = 'Shitzu',          price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'deathbike',     name = 'Deathbike Apocalypse',          brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'deathbike2',    name = 'Deathbike Future Shock',        brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'deathbike3',    name = 'Deathbike Nightmare',           brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'diablous',      name = 'Diablous',                      brand = 'Principe',        price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'diablous2',     name = 'Diablous Custom',               brand = 'Principe',        price = 38000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'double',        name = 'Double-T',                      brand = 'Dinka',           price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'enduro',        name = 'Enduro',                        brand = 'Dinka',           price = 5500,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'esskey',        name = 'Esskey',                        brand = 'Pegassi',         price = 12000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'faggio',        name = 'Faggio Sport',                  brand = 'Pegassi',         price = 2000,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'faggio2',       name = 'Faggio',                        brand = 'Pegassi',         price = 1900,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'faggio3',       name = 'Faggio Mod',                    brand = 'Pegassi',         price = 2500,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'fcr',           name = 'FCR 1000',                      brand = 'Pegassi',         price = 5000,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'fcr2',          name = 'FCR 1000 Custom',               brand = 'Pegassi',         price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'gargoyle',      name = 'Gargoyle',                      brand = 'Western',         price = 32000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'hakuchou',      name = 'Hakuchou',                      brand = 'Shitzu',          price = 17000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'hakuchou2',     name = 'Hakuchou Drag',                 brand = 'Shitzu',          price = 45000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'hexer',         name = 'Hexer',                         brand = 'LCC',             price = 16000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'innovation',    name = 'Innovation',                    brand = 'LLC',             price = 33500,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'lectro',        name = 'Lectro',                        brand = 'Principe',        price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'manchez',       name = 'Manchez',                       brand = 'Maibatsu',        price = 8300,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'nemesis',       name = 'Nemesis',                       brand = 'Principe',        price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'nightblade',    name = 'Nightblade',                    brand = 'WMC',             price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'oppressor',     name = 'Oppressor',                     brand = 'Pegassi',         price = 9999999, category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'pcj',           name = 'PCJ-600',                       brand = 'Shitzu',          price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'ratbike',       name = 'Rat Bike',                      brand = 'Western',         price = 3000,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'ruffian',       name = 'Ruffian',                       brand = 'Pegassi',         price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'sanchez',       name = 'Sanchez Livery',                brand = 'Maibatsu',        price = 5300,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'sanchez2',      name = 'Sanchez',                       brand = 'Maibatsu',        price = 5300,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'sanctus',       name = 'Sanctus',                       brand = 'LCC',             price = 35000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'shotaro',       name = 'Shotaro',                       brand = 'Nagasaki',        price = 320000,  category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'sovereign',     name = 'Sovereign',                     brand = 'WMC',             price = 8000,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'stryder',       name = 'Stryder',                       brand = 'Nagasaki',        price = 50000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'thrust',        name = 'Thrust',                        brand = 'Dinka',           price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'vader',         name = 'Vader',                         brand = 'Shitzu',          price = 7200,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'vindicator',    name = 'Vindicator',                    brand = 'Dinka',           price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'vortex',        name = 'Vortex',                        brand = 'Pegassi',         price = 31000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'wolfsbane',     name = 'Wolfsbane',                     brand = 'Western',         price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'zombiea',       name = 'Zombie Bobber',                 brand = 'Western',         price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'zombieb',       name = 'Zombie Chopper',                brand = 'Western',         price = 27000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'manchez2',      name = 'Manchez Scout',                 brand = 'Maibatsu',        price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'shinobi',       name = 'Shinobi',                       brand = 'Nagasaki',        price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'reever',        name = 'Reever',                        brand = 'Western',         price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'manchez3',      name = 'Manchez Scout Classic',         brand = 'Maibatsu',        price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'western' },
    { model = 'powersurge',    name = 'Powersurge',                    brand = 'Western',         price = 7000,    category = 'motorcycles',    type = 'bike',       shop = 'western' },
    --- Off-Road (9)
    ...
    { model = 'caddy3',        name = 'Caddy (Utility)',               brand = 'Nagasaki',        price = 30000,   category = 'utility',        type = 'automobile', shop = 'dot' },
    ...
    { model = 'towtruck',      name = 'Tow Truck (Large)',             brand = 'Vapid',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'dot' },
    { model = 'towtruck2',     name = 'Tow Truck (Small)',             brand = 'Vapid',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'dot' },
    ...
    { model = 'flatbed',       name = 'Flatbed Truck',                 brand = 'MTL',             price = 30000,   category = 'utility',        type = 'automobile', shop = 'dot' },
    --- Vans (12)
    ...
    --- Emergency (18)
    { model = 'riot',          name = 'Police Riot',                   brand = 'Brute',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'riot2',         name = 'RCV',                           brand = 'Unknown',         price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'pbus',          name = 'Police Prison Bus',             brand = 'Vapid',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'police',        name = 'Police Cruiser',                brand = 'Vapid',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'police2',       name = 'Police Buffalo',                brand = 'Vapid',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'police3',       name = 'Police Interceptor',            brand = 'Vapid',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'police4',       name = 'Unmarked Cruiser',              brand = 'Vapid',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'sheriff',       name = 'Sheriff SUV',                   brand = 'Declasse',        price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'sheriff2',      name = 'Sheriff Cruiser',               brand = 'Vapid',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'policeold1',    name = 'Police Rancher',                brand = 'Declasse',        price = 110000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'policeold2',    name = 'Police Roadcruiser',            brand = 'Albany',          price = 110000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'policet',       name = 'Police Transporter',            brand = 'Vapid',           price = 110000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'policeb',       name = 'Police Bike',                   brand = 'Vapid',           price = 110000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'polmav',        name = 'Police Maverick',               brand = 'Buckingham',      price = 110000,  category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'ambulance',     name = 'Ambulance',                     brand = 'Brute',           price = 110000,  category = 'emergency',      type = 'automobile', shop = 'medical' },
    { model = 'firetruk',      name = 'Fire Truck',                    brand = 'MTL',             price = 110000,  category = 'emergency',      type = 'automobile', shop = 'medical' },
    { model = 'lguard',        name = 'Lifeguard',                     brand = 'Declasse',        price = 110000,  category = 'emergency',      type = 'automobile', shop = 'medical' },
    { model = 'seashark2',     name = 'Seashark Lifeguard',            brand = 'Speedophile',     price = 40000,   category = 'emergency',      type = 'automobile', shop = 'medical' },
    { model = 'pranger',       name = 'Park Ranger',                   brand = 'Declasse',        price = 40000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'fbi',           name = 'FIB Buffalo',                   brand = 'Bravado',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'fbi2',          name = 'FIB Granger',                   brand = 'Declasse',        price = 40000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'predator',      name = 'Police Predator',               brand = 'Unknown',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'polgauntlet',   name = 'Gauntlet Interceptor',          brand = 'Bravado',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'police5',       name = 'Stanier LE Cruiser',            brand = 'Vapid',           price = 40000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    --- Military (19)
    ...
    -- Jakers Vehicles
    { model = 'pvcjv',         name = 'Cruiser',                       brand = 'Vapid',           price = 5000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'pvajv',         name = 'Aleutian',                      brand = 'Vapid',           price = 20000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'pvsjv',         name = 'Scout',                         brand = 'Vapid',           price = 12000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'spbbjv',        name = 'STX',                           brand = 'Bravado',         price = 8000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'spvdjv',        name = 'Dominator',                     brand = 'Vapid',           price = 25000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'spvhjv',        name = 'Valkyrie',                      brand = 'Heli',            price = 50000,  category = 'emergency',      type = 'heli',       shop = 'none' },
    { model = 'sebbjv',        name = 'EMS STX',                       brand = 'Bravado',         price = 15000,   category = 'emergency',      type = 'automobile', shop = 'medical' },
    { model = 'pvccjv',        name = 'Caracara',                      brand = 'Vapid',           price = 6000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'pvtjv',         name = 'Torrence',                      brand = 'Vapid',           price = 24000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'gresleyhellfirepd', name = 'Hellfire',                  brand = 'Gresley',         price = 18000,   category = 'emergency',      type = 'automobile', shop = 'police' },
    { model = 'pdglxjv',       name = 'Granger XL',                    brand = 'Declasse',        price = 25000,   category = 'emergency',      type = 'automobile', shop = 'police' },  
    -- JA Designs DOT
