...
QBShared.Items = {
    ...
    mdt                          = { name = 'mdt', label = 'MDT', weight = 500, type = 'item', image = 'mdt.png', unique = false, useable = true, shouldClose = true, description = 'Police Mobile Data Terminal (MDT)' },
    bodycam                      = { name = 'bodycam', label = 'Bodycam', weight = 200, type = 'item', image = 'bodycam.png', unique = false, useable = true, shouldClose = true, description = 'Police Bodycam' },
    dashcam                      = { name = 'dashcam', label = 'Dashcam', weight = 200, type = 'item', image = 'dashcam.png', unique = false, useable = true, shouldClose = true, description = 'Police Dashcam' },
    ...
    -- ears_1                       = { name = 'ears_1', label = 'Earings', weight = 100, type = 'clothes', image = 'ears_1.png', unique = true, useable = true, shouldClose = false, combinable = nil, description = 'A Useable Outfit' },
    -- decals_1                     = { name = 'decals_1', label = 'Decal', weight = 100, type = 'clothes', image = 'decals_1.png', unique = true, useable = true, shouldClose = false, combinable = nil, description = 'A Useable Outfit' },
    ...
    muzzle_attachment_10         = { name = 'muzzle_attachment_10', label = 'Muzzle 10', weight = 1000, type = 'item', image = 'smallscope_attachment.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'A muzzle for a weapon' },
        --
    barrel_attachment            = { name = 'barrel_attachment', label = 'Barrel', weight = 1000, type = 'item', image = 'smallscope_attachment.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'A barrel for a weapon' },
    ...
    -- envi-dumpsters
    bottle_cap = {name = 'bottle_cap', label = 'Bottle Cap', weight = 0, type = 'item', image = 'bottle_cap.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Currency for the hobo economy'},
    cardboard_bed = {name = 'cardboard_bed', label = 'Cardboard Bed', weight = 1, type = 'item', image = 'cardboard_bed.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Basic sleeping surface with health regeneration'},
    hobo_gloves = {name = 'hobo_gloves', label = 'Hobo Gloves', weight = 1, type = 'item', image = 'hobo_gloves.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Protection from dirty needles and hazards'},
    hobo_tent = {name = 'hobo_tent', label = 'Hobo Tent', weight = 10000, type = 'item', image = 'hobo_tent.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Shelter from the elements with premium regeneration'},
    begging_sign = {name = 'begging_sign', label = 'Begging Sign', weight = 1, type = 'item', image = 'begging_sign.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Increases begging earnings by 1.5x'},
    medical_care_package = {name = 'medical_care_package', label = 'Medical Care Package', weight = 10000, type = 'item', image = 'medical_care_package.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Emergency medical supplies for hobos'},
    rat_treats = {name = 'rat_treats', label = 'Rat Treats', weight = 1, type = 'item', image = 'rat_treats.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Ward off rat attacks when searching'},
    racoon_treats = {name = 'racoon_treats', label = 'Racoon Treats', weight = 1, type = 'item', image = 'racoon_treats.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Used to befriend wild raccoons'},
    rat_bait = {name = 'rat_bait', label = 'Rat Bait', weight = 1, type = 'item', image = 'rat_bait.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Place to attract or distract rats'},
    hobo_crown = {name = 'hobo_crown', label = 'Hobo Crown', weight = 500, type = 'item', image = 'hobo_crown.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Symbol of the Hobo King'},
    sleeping_bag = {name = 'sleeping_bag', label = 'Sleeping Bag', weight = 2000, type = 'item', image = 'sleeping_bag.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Improved rest with better health regeneration'},
    ...
    ration_pack = {name = 'ration_pack', label = 'Ration Pack', weight = 1500, type = 'item', image = 'ration_pack.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Emergency supplies with food, water, and medical items'},
    wooden_junk = {name = 'wooden_junk', label = 'Wooden Junk', weight = 100, type = 'item', image = 'wooden_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    copper_junk = {name = 'copper_junk ', label = 'Copper Junk', weight = 100, type = 'item', image = 'wooden_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    scrap_junk = {name = 'scrap_junk', label = 'Scrap Junk', weight = 100, type = 'item', image = 'scrap_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    cloth_junk = {name = 'cloth_junk', label = 'Cloth Junk', weight = 100, type = 'item', image = 'cloth_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    plastic_junk = {name = 'plastic_junk', label = 'Plastic Junk', weight = 100, type = 'item', image = 'plastic_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    electronic_junk = {name = 'electronic_junk', label = 'Electronic Junk', weight = 100, type = 'item', image = 'electronic_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    broken_phone = {name = 'broken_phone', label = 'Broken Phone', weight = 300, type = 'item', image = 'broken_phone.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'A broken phone with potential valuable parts'},
    food_waste = {name = 'food_waste', label = 'Food Waste', weight = 100, type = 'item', image = 'food_waste.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Discarded food items'},
    medical_waste = {name = 'medical_waste', label = 'Medical Waste', weight = 100, type = 'item', image = 'medical_waste.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Discarded medical supplies'},
    paper_junk = {name = 'paper_junk', label = 'Paper Junk', weight = 100, type = 'item', image = 'paper_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    glass_junk = {name = 'glass_junk', label = 'Glass Junk', weight = 100, type = 'item', image = 'glass_junk.png', unique = false, useable = false, shouldClose = true, combinable = nil, description = 'Material for recycling'},
    rabies_shot = {name = 'rabies_shot', label = 'Rabies Shot', weight = 100, type = 'item', image = 'rabies_shot.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Antidote for rabies poison effect'},
    tetanus_shot = {name = 'tetanus_shot', label = 'Tetanus Shot', weight = 100, type = 'item', image = 'tetanus_shot.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Antidote for tetanus poison effect'},
    ...
    adjustable_spanner 		= {name = 'adjustable_spanner',	label = 'Adjustable Spanner',	weight = 1000,			type = 'item',		image = 'adjustable_spanner.png',	unique = true,		useable = true,		shouldClose = true,	   combinable = nil,   description = ''},
    ...
    remote_bomb 			= {name = 'remote_bomb',		label = 'Remote Bomb',		    weight = 1000,			type = 'item',		image = 'remote_bomb.png',			unique = true,		useable = true,		shouldClose = true,	   combinable = nil,   description = ''},
	...
	["chocolate"] 				 	= {["name"] = "chocolate",  		     	["label"] = "Chocolate",	 			["weight"] = 200, 		["type"] = "item", 		["image"] = "chocolate.png", 	["unique"] = false, 	["useable"] = false, 	["shouldClose"] = false,   	["combinable"] = nil,   ["description"] = "Chocolate Bar", ['hunger'] = math.random(40, 50) },
	...
	["cranberry"] 				 	= {["name"] = "cranberry",  	     		["label"] = "Cranberry Juice",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "cranberry.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Cranberry Juice", ['thirst'] = math.random(40, 50) },
	["gin"] 					 	= {["name"] = "gin",  	     				["label"] = "Gin",	 					["weight"] = 200, 		["type"] = "item", 		["image"] = "gin.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Gin", ['thirst'] = math.random(40, 50) },
	["rum"] 					 	= {["name"] = "rum",  	     				["label"] = "Rum",	 					["weight"] = 200, 		["type"] = "item", 		["image"] = "rum.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Rum", ['thirst'] = math.random(40, 50) },
	["amaretto"] 					= {["name"] = "amaretto",  	     			["label"] = "Amaretto",	 				["weight"] = 200, 		["type"] = "item", 		["image"] = "amaretto.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Amaretto", ['thirst'] = math.random(40, 50) },
	    -- Cocktails
	...
	["ecolalight"] 					= {["name"] = "ecolalight",  	    	 	["label"] = "eCola Light",		 		["weight"] = 100, 		["type"] = "item", 		["image"] = "ecolalight.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
        -- Snacks
    ["crisps"] 						= {["name"] = "crisps",  	    			["label"] = "Crisps",					["weight"] = 100, 		["type"] = "item", 		["image"] = "chips.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	    -- Food
    ...
    -- [[Tequilala]] -----------------------------------------------------------------------------
	    -- Cocktails
	["b52"] 		 				= {["name"] = "b52",  	     				["label"] = "B-52",	 					["weight"] = 200, 		["type"] = "item", 		["image"] = "b52.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "B-52 Cocktail", ['thirst'] = math.random(40, 50) },
	["brussian"] 		 			= {["name"] = "brussian",  	     			["label"] = "Black Russian",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "brussian.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Black Russian Cocktail", ['thirst'] = math.random(40, 50) },
	["bkamikaze"] 				 	= {["name"] = "bkamikaze",  	     		["label"] = "Blue Kamikaze",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "bkamikaze.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Blue Kamikaze Cocktail", ['thirst'] = math.random(40, 50) },
	["cappucc"] 				 	= {["name"] = "cappucc",  	     			["label"] = "Cappuccinotini",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "cappucc.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Cappuccinotini Cocktail", ['thirst'] = math.random(40, 50) },
	["ccookie"] 				 	= {["name"] = "ccookie",  	     			["label"] = "Cranberry Cookie",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "ccookie.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Cranberry Cookie Cocktail", ['thirst'] = math.random(40, 50) },
	["iflag"] 				 		= {["name"] = "iflag",  	     			["label"] = "Irish Flag",	 			["weight"] = 200, 		["type"] = "item", 		["image"] = "iflag.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Irish Flag Cocktail", ['thirst'] = math.random(40, 50) },
	["kamikaze"] 				 	= {["name"] = "kamikaze",  	     			["label"] = "Kamikaze",	 				["weight"] = 200, 		["type"] = "item", 		["image"] = "kamikaze.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Kamikase Cocktail", ['thirst'] = math.random(40, 50) },
	["sbullet"] 		 			= {["name"] = "sbullet",  	     			["label"] = "Silver Bullet",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "sbullet.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Silver Bullet Cocktail", ['thirst'] = math.random(40, 50) },
	["voodoo"] 		 				= {["name"] = "voodoo",  	     			["label"] = "Voodoo",	 				["weight"] = 200, 		["type"] = "item", 		["image"] = "voodoo.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Voodoo Cocktail", ['thirst'] = math.random(40, 50) },
	["woowoo"] 		 				= {["name"] = "woowoo",  	     			["label"] = "Woo Woo",	 				["weight"] = 200, 		["type"] = "item", 		["image"] = "woowoo.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "Woowoo Cocktail", ['thirst'] = math.random(40, 50) },
	    -- Drink Ingredients
	["schnapps"] 				 	= {["name"] = "schnapps",  	     			["label"] = "Peach Schnapps",	 		["weight"] = 200, 		["type"] = "item", 		["image"] = "schnapps.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Peach Schnapps", ['thirst'] = math.random(40, 50) },
	["scotch"] 					 	= {["name"] = "scotch",  	     			["label"] = "Scotch",	 				["weight"] = 200, 		["type"] = "item", 		["image"] = "scotch.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Scotch", ['thirst'] = math.random(40, 50) },
	["icream"] 					 	= {["name"] = "icream",  	     			["label"] = "Irish Cream",	 			["weight"] = 200, 		["type"] = "item", 		["image"] = "icream.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Irish Cream Liquer", ['thirst'] = math.random(40, 50) },
	["curaco"] 						= {["name"] = "curaco",  	     			["label"] = "Curaco",	 				["weight"] = 200, 		["type"] = "item", 		["image"] = "curaco.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "A bottle of Curaco", ['thirst'] = math.random(40, 50) },
    
    -- [[Pizza This]] -----------------------------------------------------------------------------
	    -- Wine
	["amarone"] 					= {["name"] = "amarone",  	    	 		["label"] = "Amarone",		 			["weight"] = 100, 		["type"] = "item", 		["image"] = "amarone.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["barbera"] 					= {["name"] = "barbera",  	    			["label"] = "Barbera D'Asti",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "barbera.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["dolceto"] 					= {["name"] = "dolceto",  	    	 		["label"] = "Dolcetto D'Alba",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "dolceto.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["housered"] 					= {["name"] = "housered",  	    	 		["label"] = "House Red Wine",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "housered.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["housewhite"] 					= {["name"] = "housewhite",  	    	 	["label"] = "House White Wine",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "housewhite.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["rosso"] 						= {["name"] = "rosso",  	    	 		["label"] = "Rosso Del Montalcino",	 	["weight"] = 100, 		["type"] = "item", 		["image"] = "rosso.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	    -- Desserts
	["tiramisu"] 					= {["name"] = "tiramisu",  	    	 		["label"] = "Tiramisu",	 				["weight"] = 100, 		["type"] = "item", 		["image"] = "tiramisu.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["gelato"] 						= {["name"] = "gelato",  	    	 		["label"] = "Choc and Vanilla Gelato",	["weight"] = 100, 		["type"] = "item", 		["image"] = "gelato.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["medfruits"] 					= {["name"] = "medfruits",  	    	 	["label"] = "Fresh Fruit Medly",	 	["weight"] = 100, 		["type"] = "item", 		["image"] = "medfruits.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	    -- Pasta
	["bolognese"] 					= {["name"] = "bolognese",  	    	 	["label"] = "Bolognese",	 			["weight"] = 100, 		["type"] = "item", 		["image"] = "bolognese.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["calamari"] 					= {["name"] = "calamari",  	    	 		["label"] = "Calamari Marinara",		["weight"] = 100, 		["type"] = "item", 		["image"] = "calamari.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["meatball"] 					= {["name"] = "meatball",  	    	 		["label"] = "Homemade Meatballs",		["weight"] = 100, 		["type"] = "item", 		["image"] = "meatball.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["alla"] 						= {["name"] = "alla",  	    	 			["label"] = "Alla Vodka",	 			["weight"] = 100, 		["type"] = "item", 		["image"] = "alla.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["pescatore"] 					= {["name"] = "pescatore",  	    		["label"] = "Pescatore",			 	["weight"] = 100, 		["type"] = "item", 		["image"] = "pescatore.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	    -- Pizza Slices
	["capricciosa"] 				= {["name"] = "capricciosa",  	    	 	["label"] = "Capriccosa",	 			["weight"] = 100, 		["type"] = "item", 		["image"] = "capricciosa.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["diavola"] 					= {["name"] = "diavola",  	    	 		["label"] = "Diavola",	 				["weight"] = 100, 		["type"] = "item", 		["image"] = "diavola.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["marinara"] 					= {["name"] = "marinara",  	    	 		["label"] = "Marinara",	 				["weight"] = 100, 		["type"] = "item", 		["image"] = "marinara.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["margherita"] 					= {["name"] = "margherita",  	    	 	["label"] = "Margherita",	 			["weight"] = 100, 		["type"] = "item", 		["image"] = "margherita.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["prosciuttio"] 				= {["name"] = "prosciuttio",  	    		["label"] = "Prosciuttio E Funghi",		["weight"] = 100, 		["type"] = "item", 		["image"] = "proscuttio.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["vegetariana"] 				= {["name"] = "vegetariana",  	    	 	["label"] = "Vegetariana",				["weight"] = 100, 		["type"] = "item", 		["image"] = "vegetariana.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	    -- Pizza Boxes
    ...
    -- [[Pops Diner]] -----------------------------------------------------------------------------
        -- Meals
	["baconeggs"] 					= {["name"] = "baconeggs",  	    		["label"] = "Bacon and Eggs",			["weight"] = 100, 		["type"] = "item", 		["image"] = "baconeggs.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["bltsandwich"] 				= {["name"] = "bltsandwich",  	    		["label"] = "BLT Sandwich",				["weight"] = 100, 		["type"] = "item", 		["image"] = "bltsandwich.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["cheeseburger"] 				= {["name"] = "cheeseburger",  	    		["label"] = "Cheese Burger",			["weight"] = 100, 		["type"] = "item", 		["image"] = "cheeseburger.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["cheesesandwich"] 				= {["name"] = "cheesesandwich",  	    	["label"] = "Cheese Sandwich",			["weight"] = 100, 		["type"] = "item", 		["image"] = "cheesesandwich.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["eggsandwich"] 				= {["name"] = "eggsandwich",  	    		["label"] = "Eggs Sandwich",			["weight"] = 100, 		["type"] = "item", 		["image"] = "eggsandwich.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["grilledwrap"] 				= {["name"] = "grilledwrap",  	    		["label"] = "Grilled Wrap",				["weight"] = 100, 		["type"] = "item", 		["image"] = "grilledwrap.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["hamburger"] 					= {["name"] = "hamburger",  	    		["label"] = "Hamburger",				["weight"] = 100, 		["type"] = "item", 		["image"] = "hamburger.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["hamcheesesandwich"] 			= {["name"] = "hamcheesesandwich",  	    ["label"] = "Ham and Cheese Sandwich",	["weight"] = 100, 		["type"] = "item", 		["image"] = "hamcheesesandwich.png",["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["hamsandwich"] 				= {["name"] = "hamsandwich",  	    		["label"] = "Ham Sandwich",				["weight"] = 100, 		["type"] = "item", 		["image"] = "hamsandwich.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["ranchwrap"] 					= {["name"] = "ranchwrap",  	    		["label"] = "Ranch Wrap",				["weight"] = 100, 		["type"] = "item", 		["image"] = "ranchwrap.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["sausageeggs"] 				= {["name"] = "sausageeggs",  	    		["label"] = "Sausage and Eggs",			["weight"] = 100, 		["type"] = "item", 		["image"] = "sausageeggs.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["steakburger"] 				= {["name"] = "steakburger",  	    		["label"] = "Steak Burger",				["weight"] = 100, 		["type"] = "item", 		["image"] = "steakburger.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["toastbacon"] 					= {["name"] = "toastbacon",  	    		["label"] = "Bacon and Toast",			["weight"] = 100, 		["type"] = "item", 		["image"] = "toastbacon.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["tunasandwich"] 				= {["name"] = "tunasandwich",  	    		["label"] = "Tuna Sandwich",			["weight"] = 100, 		["type"] = "item", 		["image"] = "tunasandwich.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["veggiewrap"] 					= {["name"] = "veggiewrap",  	    		["label"] = "Veggie Wrap",				["weight"] = 100, 		["type"] = "item", 		["image"] = "veggiewrap.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
        -- Snacks
	["carrotcake"] 					= {["name"] = "carrotcake",  	    		["label"] = "Carrot Cake",				["weight"] = 100, 		["type"] = "item", 		["image"] = "carrotcake.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["cheesecake"] 					= {["name"] = "cheesecake",  	    		["label"] = "Cheese Cake",				["weight"] = 100, 		["type"] = "item", 		["image"] = "cheesecake.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["chocpudding"] 				= {["name"] = "chocpudding",  	    		["label"] = "Chocolate Pudding",		["weight"] = 100, 		["type"] = "item", 		["image"] = "chocpudding.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["jelly"] 						= {["name"] = "jelly",  	    			["label"] = "Jelly",					["weight"] = 100, 		["type"] = "item", 		["image"] = "jelly.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["popdonut"] 					= {["name"] = "popdonut",  	    			["label"] = "Donut",					["weight"] = 100, 		["type"] = "item", 		["image"] = "popdonut.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["popicecream"] 				= {["name"] = "popicecream",  	    		["label"] = "Ice Cream",				["weight"] = 100, 		["type"] = "item", 		["image"] = "popicecream.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	    -- Ingredients
	["chickenbreast"] 				= {["name"] = "chickenbreast",  	    	["label"] = "Chicken Breast",			["weight"] = 100, 		["type"] = "item", 		["image"] = "chickenbreast.png", 	["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["jimsausages"] 				= {["name"] = "jimsausages",  	    		["label"] = "Sausages",					["weight"] = 100, 		["type"] = "item", 		["image"] = "jimsausages.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["jimeggs"] 					= {["name"] = "jimeggs",  	    			["label"] = "Eggs",						["weight"] = 100, 		["type"] = "item", 		["image"] = "jimeggs.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
    ...
    -- [[Bean Machine]] -----------------------------------------------------------------------------
        -- Drinks
	["beancoffee"] 					= {["name"] = "beancoffee",  	    		["label"] = "Coffe Beans",				["weight"] = 100, 		["type"] = "item", 		["image"] = "beancoffee.png", 		["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	["beandonut"] 					= {["name"] = "beandonut",  	    		["label"] = "Donut",					["weight"] = 100, 		["type"] = "item", 		["image"] = "popdonut.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50) },
	...
	["watermelon"] 					= {["name"] = "watermelon",  	    		["label"] = "WaterMelon Slice",			["weight"] = 100, 		["type"] = "item", 		["image"] = "watermelon.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['hunger'] = math.random(40, 50), ['thirst'] = math.random(40, 50) },
	["bigfruit"] 					= {["name"] = "bigfruit",  	    	 		["label"] = "The Big Fruit",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "bigfruit.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["highnoon"] 					= {["name"] = "highnoon",  	    	 		["label"] = "Highnoon",		 			["weight"] = 100, 		["type"] = "item", 		["image"] = "highnoon.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["speedball"] 					= {["name"] = "speedball",  	    	 	["label"] = "The SpeedBall",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "speedball.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["gunkaccino"] 					= {["name"] = "gunkaccino",  	    	 	["label"] = "The Gunkaccino",		 	["weight"] = 100, 		["type"] = "item", 		["image"] = "gunkaccino.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["bratte"] 						= {["name"] = "bratte",  	    	 		["label"] = "The Bratte",		 		["weight"] = 100, 		["type"] = "item", 		["image"] = "bratte.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["flusher"] 					= {["name"] = "flusher",  	    	 		["label"] = "The Flusher",		 		["weight"] = 100, 		["type"] = "item", 		["image"] = "flusher.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["ecocoffee"] 					= {["name"] = "ecocoffee",  	    	 	["label"] = "The Eco-ffee",		 		["weight"] = 100, 		["type"] = "item", 		["image"] = "ecoffee.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },
	["caffeagra"] 					= {["name"] = "caffeagra",  	    	 	["label"] = "Caffeagra",		 		["weight"] = 100, 		["type"] = "item", 		["image"] = "caffeagra.png", 		["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = "", ['thirst'] = math.random(40, 50) },

	-- [[Up-N-Atom]] -----------------------------------------------------------------------------
	-- Food
	["atom-snacker"] 				 = {["name"] = "atom-snacker", 			 		["label"] = "Snacker", 					["weight"] = 250, 		["type"] = "item", 		["image"] = "atom-snacker.png", 				["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-zingerburger"] 			 = {["name"] = "atom-zingerburger", 			["label"] = "ZingerBurger", 			["weight"] = 300, 		["type"] = "item", 		["image"] = "atom-zingerburger.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-submarine"] 				 = {["name"] = "atom-submarine", 			 	["label"] = "Submarine", 				["weight"] = 310, 		["type"] = "item", 		["image"] = "atom-submarine.png", 				["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-heartstopper"] 		 	 = {["name"] = "atom-heartstopper", 			["label"] = "Heartstopper", 			["weight"] = 2500, 		["type"] = "item", 		["image"] = "atom-heartstopper.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-veggieburger"] 		 	 = {["name"] = "atom-veggieburger", 			["label"] = "Veggie Burger", 			["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-veggieburger.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-fries"] 				 	 = {["name"] = "atom-fries", 			 	  	["label"] = "Fries", 					["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-fries.png", 					["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-nuggets"] 				 = {["name"] = "atom-nuggets", 			 	  	["label"] = "Chicken Nuggets", 			["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-nuggets.png", 				["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	["atom-rings"] 				 	 = {["name"] = "atom-rings", 			 	  	["label"] = "Onion Rings", 				["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-rings.png", 					["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Sates Hunger."},
	-- Drinks
	...
	["atom-tomato"] 				 = {["name"] = "atom-tomato", 			 		["label"] = "Tomato", 					["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-tomato.png", 	    			["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "An Ingredient"},
	["atom-raw"] 				 	 = {["name"] = "atom-raw", 			 			["label"] = "Raw Patty", 				["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-patty_raw.png", 	        	["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "An Ingredient"},
	["atom-potato"] 				 = {["name"] = "atom-potato", 			 		["label"] = "Bag of Potatoes", 			["weight"] = 1500, 		["type"] = "item", 		["image"] = "atom-potato.png", 	    			["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "An Ingredient"},
	["atom-mshakeformula"] 		 	 = {["name"] = "atom-mshakeformula", 			["label"] = "Milkshake Formula", 		["weight"] = 125, 		["type"] = "item", 		["image"] = "atom-mshakeformula.png",  			["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "An Ingredient"},
	["atom-toy1"] 		 		 	 = {["name"] = "atom-toy1", 					["label"] = "Action Figure", 			["weight"] = 50, 		["type"] = "item", 		["image"] = "atom-toy1.png", 					["unique"] = true, 		["useable"] = false, 	["shouldClose"] = false,   ["combinable"] = nil,  ["description"] = "An Action Figure From the late 90's"},
	["atom-toy2"] 		 		 	 = {["name"] = "atom-toy2", 					["label"] = "Pink Teddy", 				["weight"] = 50, 		["type"] = "item", 		["image"] = "atom-toy2.png", 					["unique"] = true, 		["useable"] = false, 	["shouldClose"] = false,   ["combinable"] = nil,  ["description"] = "A Fluffy Pink Teddy from the Atic"},
	...
	["orangotang"] 			= {["name"] = "orangotang",  	    ["label"] = "Orangotang",					["weight"] = 100,["type"] = "item",["image"] = "orangotang.png", 		["unique"] = false,["useable"] = true,["shouldClose"] = true,["description"] = "", ['thirst'] = math.random(20, 30) },
    ...
    -- Lunar Drug Creator
    ['ammonia'] = {['name'] = 'ammonia', ['label'] = 'Ammonia', ['weight'] = 500, ['type'] = 'item', ['image'] = 'ammonia.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A chemical compound used in drug production.' },
    ['sodium_benzoate'] = {['name'] = 'sodium_benzoate', ['label'] = 'Sodium benzoate', ['weight'] = 750, ['type'] = 'item', ['image'] = 'sodium_benzoate.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A chemical compound used in drug production.' },
    ['meth_tray'] = {['name'] = 'meth_tray', ['label'] = 'Meth tray', ['weight'] = 1000, ['type'] = 'item', ['image'] = 'meth_tray.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A tray used for meth production.' },
    ['meth'] = {['name'] = 'meth', ['label'] = 'Meth', ['weight'] = 1, ['type'] = 'item', ['image'] = 'meth.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Methamphetamine in its pure form.' },
    ['meth_bag'] = {['name'] = 'meth_bag', ['label'] = 'Meth bag', ['weight'] = 50, ['type'] = 'item', ['image'] = 'meth_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of methamphetamine ready for sale.' },
    ['plastic_bag'] = {['name'] = 'plastic_bag', ['label'] = 'Plastic bag', ['weight'] = 40, ['type'] = 'item', ['image'] = 'plastic_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A simple plastic bag for packaging.' },
    ['meth_syringe'] = {['name'] = 'meth_syringe', ['label'] = 'Meth syringe', ['weight'] = 75, ['type'] = 'item', ['image'] = 'meth_syringe.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A syringe filled with liquid methamphetamine.' },
    ['coke_seed'] = {['name'] = 'coke_seed', ['label'] = 'Cocaine seed', ['weight'] = 10, ['type'] = 'item', ['image'] = 'coke_seed.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Seeds to grow cocaine plants.' },
    ['coke_leaf'] = {['name'] = 'coke_leaf', ['label'] = 'Cocaine leaf', ['weight'] = 50, ['type'] = 'item', ['image'] = 'coke_leaf.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Leaves from a cocaine plant.' },
    ['coke_paste'] = {['name'] = 'coke_paste', ['label'] = 'Cocaine paste', ['weight'] = 150, ['type'] = 'item', ['image'] = 'coke_paste.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Unrefined cocaine paste.' },
    ['coke'] = {['name'] = 'coke', ['label'] = 'Cocaine', ['weight'] = 1, ['type'] = 'item', ['image'] = 'coke.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Pure cocaine powder.' },
    ['coke_bag'] = {['name'] = 'coke_bag', ['label'] = 'Cocaine bag', ['weight'] = 50, ['type'] = 'item', ['image'] = 'coke_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of cocaine ready for sale.' },
    ['coke_brick'] = {['name'] = 'coke_brick', ['label'] = 'Cocaine brick', ['weight'] = 200, ['type'] = 'item', ['image'] = 'coke_brick.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A brick of compressed cocaine.' },
    ['coke_doll'] = {['name'] = 'coke_doll', ['label'] = 'Cocaine doll', ['weight'] = 500, ['type'] = 'item', ['image'] = 'coke_doll.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A doll stuffed with cocaine.' },
    ['weed_seed'] = {['name'] = 'weed_seed', ['label'] = 'Weed seed', ['weight'] = 5, ['type'] = 'item', ['image'] = 'weed_seed.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Seeds to grow marijuana plants.' },
    ['weed_pot'] = {['name'] = 'weed_pot', ['label'] = 'Flower Pot', ['weight'] = 500, ['type'] = 'item', ['image'] = 'weed_pot.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A pot for growing plants.' },
    ['trowel'] = {['name'] = 'trowel', ['label'] = 'Trowel', ['weight'] = 150, ['type'] = 'item', ['image'] = 'trowel.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A small hand tool used for digging.' },
    ['weed_bud'] = {['name'] = 'weed_bud', ['label'] = 'Weed bud', ['weight'] = 25, ['type'] = 'item', ['image'] = 'weed_bud.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Raw marijuana bud.' },
    ['clean_weed_bud'] = {['name'] = 'clean_weed_bud', ['label'] = 'Clean weed bud', ['weight'] = 20, ['type'] = 'item', ['image'] = 'clean_weed_bud.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Processed marijuana bud ready for use.' },
    ['cookie_dough'] = {['name'] = 'cookie_dough', ['label'] = 'Cookie dough', ['weight'] = 200, ['type'] = 'item', ['image'] = 'cookie_dough.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Raw cookie dough.' },
    ['weed_cookie'] = {['name'] = 'weed_cookie', ['label'] = 'Weed cookie', ['weight'] = 50, ['type'] = 'item', ['image'] = 'weed_cookie.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A cookie infused with marijuana.' },
    ['weed_bag'] = {['name'] = 'weed_bag', ['label'] = 'Weed bag', ['weight'] = 50, ['type'] = 'item', ['image'] = 'weed_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of marijuana ready for sale.' },
    ['weed_joint'] = {['name'] = 'weed_joint', ['label'] = 'Weed joint', ['weight'] = 15, ['type'] = 'item', ['image'] = 'weed_joint.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A rolled marijuana cigarette.' },
    ['weed_papers'] = {['name'] = 'weed_papers', ['label'] = 'Weed papers', ['weight'] = 5, ['type'] = 'item', ['image'] = 'weed_papers.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Rolling papers for making joints.' },
    ['poppy_seeds'] = {['name'] = 'poppy_seeds', ['label'] = 'Poppy seeds', ['weight'] = 5, ['type'] = 'item', ['image'] = 'poppy_seeds.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Seeds used to grow poppy plants.' },
    ['poppy_plant'] = {['name'] = 'poppy_plant', ['label'] = 'Poppy plant', ['weight'] = 100, ['type'] = 'item', ['image'] = 'poppy_plant.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A harvested poppy plant.' },
    ['opium'] = {['name'] = 'opium', ['label'] = 'Opium', ['weight'] = 1, ['type'] = 'item', ['image'] = 'opium.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Raw opium extracted from poppy plants.' },
    ['heroin'] = {['name'] = 'heroin', ['label'] = 'Heroin', ['weight'] = 1, ['type'] = 'item', ['image'] = 'heroin.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Processed heroin powder.' },
    ['heroin_bag'] = {['name'] = 'heroin_bag', ['label'] = 'Heroin bag', ['weight'] = 50, ['type'] = 'item', ['image'] = 'heroin_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of heroin ready for sale.' },
    ['heroin_syringe'] = {['name'] = 'heroin_syringe', ['label'] = 'Heroin syringe', ['weight'] = 75, ['type'] = 'item', ['image'] = 'heroin_syringe.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A syringe filled with liquid heroin.' },
    ['syringe'] = {['name'] = 'syringe', ['label'] = 'Syringe', ['weight'] = 25, ['type'] = 'item', ['image'] = 'syringe.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'An empty syringe.' },
    ['ergot_fungus'] = {['name'] = 'ergot_fungus', ['label'] = 'Ergot fungus', ['weight'] = 50, ['type'] = 'item', ['image'] = 'ergot_fungus.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A fungus used in LSD production.' },
    ['generic_leaf'] = {['name'] = 'generic_leaf', ['label'] = 'Leaf', ['weight'] = 20, ['type'] = 'item', ['image'] = 'generic_leaf.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A common leaf.' },
    ['lsd_liquid'] = {['name'] = 'lsd_liquid', ['label'] = 'LSD liquid', ['weight'] = 25, ['type'] = 'item', ['image'] = 'lsd_liquid.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Liquid LSD solution.' },
    ['lsd'] = {['name'] = 'lsd', ['label'] = 'LSD', ['weight'] = 1, ['type'] = 'item', ['image'] = 'lsd.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'LSD tabs ready for consumption.' },
    ['art_papers'] = {['name'] = 'art_papers', ['label'] = 'Art papers', ['weight'] = 5, ['type'] = 'item', ['image'] = 'art_papers.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Decorative papers used for LSD tabs.' },
    ['safrole_oil'] = {['name'] = 'safrole_oil', ['label'] = 'Safrole oil', ['weight'] = 300, ['type'] = 'item', ['image'] = 'safrole_oil.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'An oil used in ecstasy production.' },
    ['ecstasy_crystals'] = {['name'] = 'ecstasy_crystals', ['label'] = 'Ecstasy crystals', ['weight'] = 1, ['type'] = 'item', ['image'] = 'ecstasy_crystals.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'MDMA crystals.' },
    ['ecstasy_pill'] = {['name'] = 'ecstasy_pill', ['label'] = 'Ecstasy pill', ['weight'] = 15, ['type'] = 'item', ['image'] = 'ecstasy_pill.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A pressed ecstasy pill.' },
    ['mushrooms'] = {['name'] = 'mushrooms', ['label'] = 'Mushrooms', ['weight'] = 1, ['type'] = 'item', ['image'] = 'mushrooms.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Psychedelic mushrooms.' },
    ['mushroom_powder'] = {['name'] = 'mushroom_powder', ['label'] = 'Mushroom powder', ['weight'] = 1, ['type'] = 'item', ['image'] = 'mushroom_powder.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Ground mushroom powder.' },
    ['chocolate_chips'] = {['name'] = 'chocolate_chips', ['label'] = 'Chocolate chips', ['weight'] = 30, ['type'] = 'item', ['image'] = 'chocolate_chips.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Chocolate chips for baking.' },
    ['mushroom_chocolate'] = {['name'] = 'mushroom_chocolate', ['label'] = 'Mushroom chocolate', ['weight'] = 45, ['type'] = 'item', ['image'] = 'mushroom_chocolate.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Chocolate infused with psychedelic mushrooms.' },
    ['anesthetic'] = {['name'] = 'anesthetic', ['label'] = 'anesthetic', ['weight'] = 200, ['type'] = 'item', ['image'] = 'anesthetic.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Medical anesthetic used for animals.' },
    ['ketamine'] = {['name'] = 'ketamine', ['label'] = 'Ketamine', ['weight'] = 1, ['type'] = 'item', ['image'] = 'ketamine.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Processed ketamine powder.' },
    ['ketamine_bag'] = {['name'] = 'ketamine_bag', ['label'] = 'Ketamine bag', ['weight'] = 50, ['type'] = 'item', ['image'] = 'ketamine_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of ketamine ready for sale.' },
    ['baking_soda'] = {['name'] = 'baking_soda', ['label'] = 'Baking soda', ['weight'] = 100, ['type'] = 'item', ['image'] = 'baking_soda.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Sodium bicarbonate used in crack production.' },
    ['crack'] = {['name'] = 'crack', ['label'] = 'Crack', ['weight'] = 1, ['type'] = 'item', ['image'] = 'crack.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Crack cocaine rocks.' },
    ['crack_bag'] = {['name'] = 'crack_bag', ['label'] = 'Crack bag', ['weight'] = 50, ['type'] = 'item', ['image'] = 'crack_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of crack cocaine ready for sale.' },
    ['crack_pipe'] = {['name'] = 'crack_pipe', ['label'] = 'Crack pipe', ['weight'] = 150, ['type'] = 'item', ['image'] = 'crack_pipe.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A pipe for smoking crack cocaine.' },
    ['crack_syringe'] = {['name'] = 'crack_syringe', ['label'] = 'Crack syringe', ['weight'] = 75, ['type'] = 'item', ['image'] = 'crack_syringe.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A syringe filled with liquid crack cocaine.' },
    ['pipe'] = {['name'] = 'pipe', ['label'] = 'Pipe', ['weight'] = 100, ['type'] = 'item', ['image'] = 'pipe.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A simple pipe for smoking.' },
    ['npp_chemical'] = {['name'] = 'npp_chemical', ['label'] = 'NPP chemical', ['weight'] = 300, ['type'] = 'item', ['image'] = 'npp_chemical.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A chemical used in fentanyl production.' },
    ['aniline_solution'] = {['name'] = 'aniline_solution', ['label'] = 'Aniline solution', ['weight'] = 250, ['type'] = 'item', ['image'] = 'aniline_solution.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A solution used in fentanyl production.' },
    ['fentanyl'] = {['name'] = 'fentanyl', ['label'] = 'Fentanyl', ['weight'] = 1, ['type'] = 'item', ['image'] = 'fentanyl.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Pure fentanyl powder.' },
    ['fentanyl_bag'] = {['name'] = 'fentanyl_bag', ['label'] = 'Fentanyl bag', ['weight'] = 25, ['type'] = 'item', ['image'] = 'fentanyl_bag.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A bag of fentanyl ready for sale.' },
    ['meth_table'] = {['name'] = 'meth_table', ['label'] = 'Meth table', ['weight'] = 2250, ['type'] = 'item', ['image'] = 'meth_table.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A table setup for meth production.' },
    ['coke_table'] = {['name'] = 'coke_table', ['label'] = 'Coke table', ['weight'] = 2250, ['type'] = 'item', ['image'] = 'coke_table.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A table setup for cocaine processing.' },
    ['weed_table'] = {['name'] = 'weed_table', ['label'] = 'Weed table', ['weight'] = 2250, ['type'] = 'item', ['image'] = 'weed_table.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A table setup for marijuana processing.' },
    ['chem_table'] = {['name'] = 'chem_table', ['label'] = 'Chemistry table', ['weight'] = 2250, ['type'] = 'item', ['image'] = 'chem_table.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A table setup for chemical processing.' },
    ['burner_phone'] = {['name'] = 'burner_phone', ['label'] = 'Burner phone', ['weight'] = 200, ['type'] = 'item', ['image'] = 'burner_phone.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A disposable phone that cannot be traced.' },
    ['light1'] = {['name'] = 'light1', ['label'] = 'Portable Lamp', ['weight'] = 2000, ['type'] = 'item', ['image'] = 'light1.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A portable light source.' },
    ['light2'] = {['name'] = 'light2', ['label'] = 'Portable Lamp', ['weight'] = 2000, ['type'] = 'item', ['image'] = 'light2.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A portable light source.' },
    ['fertilizer'] = {['name'] = 'fertilizer', ['label'] = 'Fertilizer', ['weight'] = 250, ['type'] = 'item', ['image'] = 'fertilizer.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'Plant nutrients to help growth.' },
    ['water_can'] = {['name'] = 'water_can', ['label'] = 'Watering can', ['weight'] = 250, ['type'] = 'item', ['image'] = 'water_can.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A can for watering plants.' },
    ...
    -- cs-advancedradio
    radio_jammer                 = { name = 'radio_jammer', label = 'Radio Jammer', weight = 1000, type = 'item', image = 'radio_jammer.png', unique = false, useable = false, shouldClose = true, description = 'This is a radio jammer.' },
    vehicle_jammer               = { name = 'vehicle_jammer', label = 'Vehicle Jammer', weight = 1000, type = 'item', image = 'vehicle_jammer.png', unique = false, useable = false, shouldClose = true, description = 'This is a vehicle jammer.' },
    radio_scanner                = { name = 'radio_scanner', label = 'Radio Scanner', weight = 1000, type = 'item', image = 'radio_scanner.png', unique = false, useable = false, shouldClose = true, description = 'This is a radio scanner.' },

    -- Customs
    ['trimmer'] = {['name'] = 'trimmer', ['label'] = 'Trimmer', ['weight'] = 150, ['type'] = 'item', ['image'] = 'trimmer.png', ['unique'] = false, ['useable'] = false, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A small hand tool used for trimming.' },

    -- pscripts policejob
    ['spike_strip'] = { name = 'spike_strip', label = 'Spike strip', weight = 50, unique = false, type = 'item', close = true, useable = true, image = 'spike_strip.png', },
	['headbag'] = { name = 'headbag', label = 'Head bag', weight = 50, unique = false, type = 'item', close = false, image = 'headbag.png', },
	['police_diving_suit'] = { name = 'police_diving_suit', label = 'Police Diving Suit', weight = 2000, unique = true, type = 'item', useable = true, image = 'police_diving_suit.png', },
	['player_clothes'] = { name = 'player_clothes', label = 'Your clothes', weight = 200, unique = true, type = 'item', useable = true, image = 'player_clothes.png', },
	['bullet'] = { name = 'bullet', label = 'Bullet', weight = 50, unique = true, type = 'item', useable = false, image = 'bullet.png', },
	['stick'] = { name = 'stick', label = 'Clear stick', weight = 20, type = 'item', unique = false, useable = false, image = 'stick.png', },
	['stick_bag'] = { name = 'stick_bag', label = 'Bag for stick', weight = 30, type = 'item', unique = true, useable = false, image = 'stick_bag.png', },
	['stick_bag_blood'] = { name = 'stick_bag_blood', label = 'Bag with stick', weight = 60, type = 'item', unique = true, useable = false, image = 'stick_bag_blood.png', },
	['fingerprint'] = { name = 'fingerprint', label = 'Fingerprint', weight = 100, type = 'item', unique = true, useable = false, image = 'fingerprint.png', },
	['fingerprinter'] = { name = 'fingerprinter', label = 'Fingerprint pillow', weight = 300, type = 'item', unique = true, useable = false, image = 'fingerprinter.png', },
	['tracking_band'] = { name = 'tracking_band', label = 'GPS Band', weight = 300, type = 'item', unique = true, useable = false, image = 'tracking_band.png',},
	['radio'] = { name = 'radio', label = 'Radio', type = 'item', weight = 1000, unique = true, useable = false, image = 'radio.png', },
	['vest_normal'] = { name = 'vest_normal', label = 'Bulletproof Vest', weight = 3000, type = 'item', useable = true, unique = true, image = 'vest_normal.png', },
	['vest_strong'] = { name = 'vest_strong', label = 'Strong Bulletproof Vest', weight = 3000, type = 'item', unique = true, useable = true, image = 'vest_strong.png', },
	['body_cam'] = { name = 'body_cam', label = 'Police Bodycam', weight = 200, useable = true, type = 'item', unique = true, image = 'body_cam.png', },
	['gps'] = { name = 'gps', label = 'GPS', weight = 100, unique = true, useable = true, type = 'item', close = true, image = 'gps.png', },
	['camera'] = { name = 'camera', label = 'Camera', unique = true, useable = true, close = true, weight = 1000, type = 'item', image = 'camera.png', },
	['photo'] = { name = 'photo', label = 'Photo', unique = true, useable = true, close = true, weight = 10, type = 'item', image = 'photo.png', },
	['handcuffs'] = { name = 'handcuffs', label = 'Handcuffs', weight = 100, unique = true, close = false, useable = true, type = 'item', image = 'handcuffs.png', },
	['rope'] = { name = 'rope', label = 'Rope', weight = 100, unique = true, close = false, useable = false, type = 'item', image = 'rope.png', },
	['police_radar'] = { name = 'police_radar', label = 'Police Radar', weight = 100, close = true, useable = true, unique = true, type = 'item', image = 'police_radar.png', },
	['mouthtape'] = { name = 'mouthtape', label = 'Mouth Tape', weight = 100, unique = true, close = false, useable = false, type = 'item', image = 'mouthtape.png', },

    -- ThinLineSanctuary Rifles
    weapon_dd11_b                = { name = 'weapon_dd11_b', label = 'DDM4V7 11 Black', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 11 Black' },
    weapon_dd11_od               = { name = 'weapon_dd11_od', label = 'DDM4V7 11 OD', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 11 OD' },
    weapon_dd11_c                = { name = 'weapon_dd11_c', label = 'DDM4V7 11 Coyote', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 11 Coyote' },
    weapon_dd14_b                = { name = 'weapon_dd14_b', label = 'DDM4V7 14 Black', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 14 Black' },
    weapon_dd14_od               = { name = 'weapon_dd14_od', label = 'DDM4V7 14 OD', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 14 OD' },
    weapon_dd14_c                = { name = 'weapon_dd14_c', label = 'DDM4V7 14 Coyote', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 14 Coyote' },
    weapon_dd16_b                = { name = 'weapon_dd16_b', label = 'DDM4V7 16 Black', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 16 Black' },
    weapon_dd16_od               = { name = 'weapon_dd16_od', label = 'DDM4V7 16 OD', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 16 OD' },
    weapon_dd16_c                = { name = 'weapon_dd16_c', label = 'DDM4V7 16 Coyote', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_assaultrifle_mk2.png', unique = true, useable = true, description = 'DDM4V7 16 Coyote' },

    -- envi-trapphone
    ['trap_phone'] = { name = 'trap_phone', label = 'Trap Phone', weight = 100, type = 'item', image = 'trap_phone.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Trap-Line Bling...', },
    ['scales'] = { name = 'scales', label = 'Scales', weight = 50, type = 'item', image = 'scales.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'Great for weighing things', },
    ['batteries'] = { name = 'batteries', label = 'AAA Batteries', weight = 20, type = 'item', image = 'batteries.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Extra long life', },
    ['baggies'] = { name = 'baggies', label = 'Baggies', weight = 20, type = 'item', image = 'baggies.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Great for holding small things', },
    ['large_baggies'] = { name = 'large_baggies', label = 'Large Baggies', weight = 20, type = 'item', image = 'large_baggies.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Great for holding bigger amounts of small things', },
